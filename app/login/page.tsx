...
const LOGIN_BG = publicAssetUrl('/fondo.png')
...
export default function LoginPage() {
  ...
  return (
    <div
      className="min-h-screen relative bg-cover bg-no-repeat bg-[position:72%_center] lg:bg-[position:left_center]"
      style={{ backgroundImage: `url('${LOGIN_BG}')` }}
      role="main"
    >
      <div className="absolute inset-0 bg-white/30 lg:bg-transparent pointer-events-none" aria-hidden />

      <div className="relative min-h-screen flex items-center justify-center px-4 py-8 sm:px-6 lg:justify-end lg:pr-[6vw] xl:pr-[10vw] 2xl:pr-[12vw]">
        <div className="w-full max-w-md bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-white/70">
          <div
      ...
      <HelpLauncher variant="floating" className="left-5 right-auto lg:left-6 lg:right-auto" />
    </div>
  )
}
