...
export const ADMIN_PERMISSION_CATALOG = [
  ...
  { key: 'view_audit', label: 'Consultar bitácora de auditoría' },
  { key: 'view_ops', label: 'Ver monitor operativo del servidor' },
...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, AdminPermissionKey[]> = {
  ...
  [UserRole.AUDITOR]: [...REPORT_PERMS, 'view_audit', 'view_ops', 'view_monitor'],
