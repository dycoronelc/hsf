...
exports.getEmailLogoSrc = getEmailLogoSrc;
exports.buildEmailHtml = buildEmailHtml;
exports.emailParagraph = emailParagraph;
exports.emailMutedNote = emailMutedNote;
exports.emailSmallPrint = emailSmallPrint;
exports.emailButton = emailButton;
exports.emailCodeDisplay = emailCodeDisplay;
exports.emailDataTable = emailDataTable;
exports.emailHighlightBox = emailHighlightBox;
exports.emailBadge = emailBadge;
const fs = require("fs");
...
function emailCodeDisplay(code) {
...
function emailHighlightBox(innerHtml) {
