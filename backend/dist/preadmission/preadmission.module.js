...
const preadmission_storage_module_1 = require("./preadmission-storage.module");
const preadmission_schema_bootstrap_1 = require("./preadmission-schema.bootstrap");
...
exports.PreadmissionModule = PreadmissionModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [preadmission_service_1.PreadmissionService, preadmission_schema_bootstrap_1.PreadmissionSchemaBootstrap],
    })
], PreadmissionModule);
